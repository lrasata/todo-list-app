...
describe('DrawerAppBar component', () => {
    test('renders with all menu items', () => {
        ...
        render(<DrawerAppBar navItems={navItems} handleOnClickNavigate={() => {}} handleOnClickLogout={() => {}}/>);
    ...
    test('renders menu items with correct onClick function ', async () => {
        ...
        render(<DrawerAppBar navItems={navItems} handleOnClickNavigate={handleOnClickNavigate}
                             handleOnClickLogout={() => {
                             }}/>);
